...
const LICENSED_STATES = ["CT","FL","GA","SC","TN","OH","NC","PA","MD","NJ","MA"];

export default function Footer({ mode }: { mode: Mode }) {
  const { t } = useLanguage();
  const logoSrc = mode === "personal" ? "/logos/personal-logo.png" : "/logos/commercial-logo.png";
  ...
  return (
    <footer style={{ backgroundColor: "#0B1F33" }}>
      ...
      <div className="footer-grid">
          ...
          <div style={{ display: "flex", gap: "16px", marginBottom: "18px" }}>
            {SOCIAL_LINKS.map((s) => (
              <a
                ...
                aria-label={s.label}
                style={{ color: "rgba(255,255,255,0.50)", transition: "color 150ms ease", display: "flex" }}
        ...
        {/* Col 2 — Contact */}
        <div>
          <p style={{ fontSize: "11px", letterSpacing: "2px", fontWeight: 700, textTransform: "uppercase", color: "#F5A623", marginBottom: "16px" }}>
            Contact
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <a
              href="tel:5619468261"
              style={{ display: "flex", alignItems: "center", gap: "8px", color: "rgba(255,255,255,0.80)", fontSize: "14px", textDecoration: "none", transition: "color 150ms ease" }}
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "8px", color: "rgba(255,255,255,0.55)", fontSize: "13px", lineHeight: 1.5 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              ...
              <a
                key={label}
                href={href}
                style={{ color: "rgba(255,255,255,0.55)", fontSize: "14px", textDecoration: "none", transition: "color 150ms ease" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#FFFFFF"; }}
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
            {[
              ...
              <a
                key={key}
                href={href}
                style={{ color: "rgba(255,255,255,0.35)", fontSize: "12px", textDecoration: "none", transition: "color 150ms ease" }}
        ...
        <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.28)", lineHeight: 1.65, margin: "12px 0 0" }}>
          {t("footer.disclaimer")}
        </p>
      </div>
    </footer>
